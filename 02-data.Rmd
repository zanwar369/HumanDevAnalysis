...
Additionally, the process of international data collection provides its own set of challenges. The Reader's Guide notes the data in these datasets are collected from "international data agencies with the mandate, resources, and expertise to collect national data on specific indicators," but also (as above) notes the potential for discrepancies ["Human Development Report 2019: Reader's Guide", United Nations Development Programme, 2019]. International data collection can be complicated by numerous factors, including variation in infrastructural development, access to technology or stable internet connection, incidents of human rights or humanitarian crises, political violence or instability, and more. As this study focuses on patterns among factor variables, rather than patterns in missing or incomplete country data, we do not specifically address these potential impediments. We posit this trend as an important direction for further research.